        ...
        <form id="formedit">
            <table style="margin: 0 auto; padding: 10px;width: 90%">
                ...
                <tr>
                    ...
                    <td>案件编号:</td>
                    <td><input id="editajbh" name="ajbh" class="easyui-textbox" /></td>
                </tr>
                <tr>
                    <td>简要案情:</td>
              ...
              <%--  <tr>
                ...
                <tr>
                    <td>案发地点:</td>
                    <td colspan="3"><input id="afdd" name="afdd" class="easyui-textbox" style="width:635px;height:50px"/></td>
                </tr>
            </table>
        </form>
    </div>
...
<script>
    $(function () {
        ...
        checkUserIdedit(rowData.zbmjCertificateNo)
