$(function () {
    ...
    $('#role_datagrid').datagrid({
        ...
        method: 'get',
        // url: 'getRoles.do',
        url: '/sscw/zhfz/common/role/getRoles.do',
        queryParams: {
    ...
    //加载权限数据
    $('#authority-tree').tree({
        url: "/sscw/zhfz/common/authority/getAuthorityTree.do",
        checkbox: true,
        cascadeCheck: false,
...
function rolegridData(row) {
    ...
    jQuery.ajax({
        ...
        url: '/sscw/zhfz/common/authority/getRoleAuthority.do',
...
function saveRoleAuthority() {
    ...
    if (dataGridSelected) {
        ...
        jQuery.ajax({
            method: "POST",
            url: '/sscw/zhfz/common/authority/savaRoleAuthority.do',
...
function addRole() {
    ...
    url = '/sscw/zhfz/common/role/add.do';
}
//修改角色信息
function editRole(index) {
    ...
    if (row) {
        ...
        url = '/sscw/zhfz/common/role/edit.do?id=' + row.id;
    } else {
        ...
        $.messager.confirm('提示', '是否删除数据?', function (r) {
            if (r) {
                ...
                jQuery.ajax({
                    type: 'POST',
                    contentType: 'application/json',
                    url: '/sscw/zhfz/common/role/delete.do',
                    data: '{"id":' + row.id + '}',
                    dataType: 'json',
                    success: function (data) {
                        $.messager.show({
