...
<head>
    ...
    <script type="text/javascript" src="roleCs.js"></script>
</head>
    ...
    <div data-options="region:'east',split:true,border:false" style="width: 35%; height: 100%;" title="权限">
        <div class="easyui-panel" title="权限"
            ...
            <div style="height: 5%; padding-top: 3px;">
                ...
                &nbsp;&nbsp;&nbsp; <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-save'" onclick="saveRoleAuthorityCs()" id="saveRoleAuthority">保存</a>
            </div>
            <hr>
...
<div id="role_dialog" class="easyui-dialog"
    ...
    <form id="role_form" class="form-style" method="post" style="height: 170px;">
        ...
        <div class="fitem">
            ...
            <select id="dataAuth" class="easyui-combobox" name="dataAuth" required="true" data-options="editable:false,panelHeight:'auto'" style="width: 200px">
        ...
        <div class="fitem">
            ...
            <select id="invDataAuth" class="easyui-combobox" name="invDataAuth" required="true" data-options="editable:false,panelHeight:'auto'" style="width: 200px">
                <option value="0">本人</option>
        ...
        <div class="fitem">
            ...
            <select id="jzDataAuth" class="easyui-combobox" name="jzDataAuth" required="true" data-options="editable:false,panelHeight:'auto'" style="width: 200px">
                <option value="0">本人</option>
                <option value="5">本部门</option>
                <option value="6">本部门及下级部门</option>
                <option value="7">上级部门及其下级部门</option>
        ...
        <div class="fitem">
            <label>考评数据权限:</label>
            <select id="kpDataAuth" class="easyui-combobox" name="kpDataAuth" required="true" data-options="editable:false,panelHeight:'auto'" style="width: 200px">
                <option value="0">本办案场所考评数据</option>
                <option value="6">法制人员本人数据</option>
                <option value="4">全部的考评数据</option>
            </select>
        </div>
    </form>
    <div id="dlg-buttons">
