...
<div id="left">
	...
	<div id="left-certificateToolbar" style="padding:5px;height:auto">
		<div style="margin-bottom:5px">
			<a  href="#" class="easyui-linkbutton" iconCls="icon-add" id="questionAdd" onclick="doAdd('新增问题','question/add.do','#left-certificate-form',0)">添加</a>
		</div>
		<div>
            <form  id="left-search" style="float: left;margin: 3px;">
                内容: <input name="content" class="easyui-validatebox" style="width:200px">
                类型: <input name="typeId" class="easyui-combobox" data-options="data:[{'id':1,'text':'询问'},{'id':2,'text':'讯问'}],valueField:'id',textField:'text'" style="width:200px">
            </form>
...
<div id="right">
	...
	<div id="right-certificateToolbar" style="padding:5px;height:auto">
		<div style="margin-bottom:5px">
			<a  href="#" class="easyui-linkbutton" iconCls="icon-add" id="answerAdd" onclick="doAdd('新增答案','answer/add.do','#right-certificate-form',1)">添加</a>
		</div>
		<div>
...
<div id="certificate-dialog" class="easyui-dialog"
	...
	<div style="height: 150px;">
		<form id="left-certificate-form" class="form-style" method="post"
			...
			<div class="fitem">
				<label>问题类型:</label> <input name="typeId" class="easyui-combobox"
										  required="true" style="width: 173px;"
											data-options="data:[{'id':1,'text':'询问'},{'id':2,'text':'讯问'}],valueField:'id',textField:'text'" /><span style="color:#F00"> * </span>
			</div>
			<div class="fitem">
            ...
            <div class="fitem">
				<label>是否重点:</label> <input name="isMajor" class="easyui-validatebox"
											required="true"
											data-options="validType:'maxLength[128]',invalidMessage:'最长128字节'"><span style="color:#F00"> * 0为是1为否</span>
			</div>
		</form>
		<form id="right-certificate-form" class="form-style" method="post"
			...
			<div class="fitem">
				<label>答案内容:</label> <textarea rows=5 name="content" class="textarea easyui-validatebox" style="width: 275px;height: 52px;" required="true"></textarea><span style="color:#F00"> * </span>
