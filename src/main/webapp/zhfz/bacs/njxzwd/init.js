...
function init(){
    jQuery.ajax({
        type: 'POST',
        url: contextPath + '/zhfz/bacs/combobox/listKnowledgeCrime.do',
        ...
        success: function (data) {
            $('#query-combobox,#save-combobox').combobox({
                data: data,
                valueField: 'id',
                textField: 'value'
            });
...
$(function () {
    $('#left-certificategrid').datagrid({
        ...
        columns: [[
            {field: 'typeName', title: '问题类型', width: 80},
            // {field: 'crimeName', title: '案件名称', width: 120},
