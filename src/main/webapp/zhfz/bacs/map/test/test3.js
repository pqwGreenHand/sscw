...
var my_vector=new ol.layer.Vector({
	source: new ol.source.Vector({
	  url: contextPath+'/bacs/map/getRegionGeoMapData.do',// 110100.json bei_jing.geo.json b1.json
...
var orgStyle = new ol.style.Style({
        image: new ol.style.Icon(/** @type {olx.style.IconOptions} */ ({
          src: contextPath+'/image/map/jinghui1.gif'
        }))
      });

var org_vector=new ol.layer.Vector({
	source: new ol.source.Vector({
	  url: contextPath+'/bacs/map/getOrgGeoMapData.do',// 110100.json bei_jing.geo.json
	//url: 'p2.json',
	  format: new ol.format.GeoJSON()
	}),
