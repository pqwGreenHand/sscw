...
<script type="text/javascript" src="exhibit.js"></script>
</head>
...
<div id="export_dialog" class="easyui-dialog"
	...
	<div id="areaToolbar" style="padding: 5px; height: auto">
		<div style="margin-bottom: 5px">
			<!-- <a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" name="noButton"
				id="enterprisebtnadd" onclick="belongAdd()">新增</a> -->
			<%--	<a href="#" class="easyui-linkbutton" iconCls="icon-set" plain="true" name="noButton"
				id="enterprisebtnadd" onclick="printConfig()">打印设置</a>
				<a href="#" class="easyui-linkbutton" iconCls="icon-help" plain="true" name="noButton"
				id="enterprisebtnadd" onclick="printHelp()">打印帮助</a> --%>
