            ...
            <div id="stepDiv1"  class="bd" style="overflow: auto;">
                ...
                <table class="main_form1" style="color: white;border-collapse: separate;border-spacing: 10px;margin-top: 20px;">
                    ...
                    <tr>
                        ...
                        <%--<td colspan="2">--%>
                            <%--<font id="cuffFont" color="red" >*请扫描卡片或选择嫌疑人姓名*</font>--%>
                        <%--</td>--%>
                    ...
                    <%--<tr>--%>
                        <%--<td><label>嫌疑人姓名:</label></td>--%>
                        <%--<td><input id="serialId" name="serialId" class="easyui-combogrid" required="true" data-options="editable:false"--%>
                                   <%--style="margin: -2px; width: 170px; height: 28px"><font color="red" style="margin-left: 2px;">*</font></td>--%>
                    <%--</tr>--%>
                    <tr>
                        <td><label>储物柜编号：</label></td>
                        <td><input id="lockerId" name="lockerId" class="easyui-combobox" required="true" style="margin: -2px; width: 170px; height: 28px" data-options="editable:false"><font color="red" style="margin-left: 2px;">*</font></td>
                         <td><label>物品名称：</label></td>
                        <td><input id="names1" name="name" class="easyui-combobox" required="true" style="margin: -2px; width: 170px; height: 28px" data-options="url: './combobox_belongin_data.json',valueField: 'id',textField: 'text',validType:'maxLength[128]',invalidMessage:'最长128字节'"><font color="red" style="margin-left: 2px;">*</font></td>
                    ...
                    <tr>
                     <td>保管措施:</td>
                        ...
                        <%--<td><button class="m-btn-1 blue" style="width: 113px;" onclick="belongAdd()">增加物品</button></td>--%>
                        <td colspan="2">
