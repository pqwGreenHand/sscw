...
<head>
    ...
    <script type="text/javascript" src="receptionHistory.js"></script>
...
<div id="toolbar" style="height: auto;padding: 5px;">
    <div>
        ...
        证件号:<input id="s_certificateNo" class="easyui-validatebox" style="width: 180px;height:25px">
        ...
        <a href="receptionentrance.jsp" name="noButton" class="easyui-linkbutton" iconCls="icon-back">返回</a>
    </div>
</div>
