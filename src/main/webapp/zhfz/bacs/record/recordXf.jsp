...
<script type="text/javascript" src="recordXf.js"></script>
...
<%@ include file="../../common/common-loading.jsp"%>
			...
			<table width="100%" height="100%">
				<tr>
					<td>
						<div class="fitem">
							<label>嫌疑人姓名:</label>
							<select id="serialId" name="serialId" class="easyui-combobox" style = "margin:-2px;width:170px" editable="false"  required="true"></select>
						</div>
					</td>
					<td>
						<div class="fitem">
				...
				<tr>
					<td>
						<div class="fitem">
							<label>笔录类型:</label>
							<select id="flageType" name="flageType" class="easyui-combobox"  style = "margin:-2px;width:170px;" data-options="required:true,url: './recordTemp_data.json',method: 'get',valueField: 'id',textField: 'text'" editable="false"/>
						</div>
					</td>
					<td>
						<!-- <div class="fitem">
						...
						<div class="fitem">
								<label>案件编号:</label>
								<input id="caseNo" name="caseNo" class="easyui-validatebox" style = "margin:-2px;width:170px" required="true" data-options="validType:'maxLength[128]',invalidMessage:'最长128字节'"/>
							</div>
	...
	<div id="certificateToolbar" style="padding:5px;height:auto;overflow: hidden;">
		<div style="width: 100%;height: 100%;text-align: center;">
			...
			<a class="myButton i1 m-box" id="recordAddXf"  href="javascript:void(0)" onclick="recordAdd()">
				<span>开始审讯</span>
				<div class="edges">
					<i class="i1"></i><i class="i2"></i><i class="i3"></i><i class="i4"></i>
				</div>
