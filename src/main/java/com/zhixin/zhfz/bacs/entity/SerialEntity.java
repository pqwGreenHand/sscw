...
public class SerialEntity implements java.io.Serializable {
	...
	private String unRelationReason;

	public String getUnRelationReason() {
		return unRelationReason;
	}

	public void setUnRelationReason(String unRelationReason) {
		this.unRelationReason = unRelationReason;
	}
	...
	private Integer inUserCertificateNo1;
	...
	private Integer sftjcl;//是否提交材料

	private Date sxDate;//首次审讯时间
	...
	//嫌疑人出区添加
	private String cuffIcNo;

	public Integer getInUserCertificateNo1() {
		return inUserCertificateNo1;
	}

	public void setInUserCertificateNo1(Integer inUserCertificateNo1) {
		this.inUserCertificateNo1 = inUserCertificateNo1;
	}

	public String getCuffIcNo() {
		return cuffIcNo;
	}

	public void setCuffIcNo(String cuffIcNo) {
		this.cuffIcNo = cuffIcNo;
	}
	...
	public Integer getSftjcl() {
		return sftjcl;
	}

	public void setSftjcl(Integer sftjcl) {
		this.sftjcl = sftjcl;
	}
