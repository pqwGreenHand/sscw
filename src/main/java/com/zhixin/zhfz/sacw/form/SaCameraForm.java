...
public class SaCameraForm implements Serializable {
    ...
    private SaCameraListForm listForm;
    ...
    public SaCameraListForm getListForm() {
        return listForm;
    }

    public void setListForm(SaCameraListForm listForm) {
