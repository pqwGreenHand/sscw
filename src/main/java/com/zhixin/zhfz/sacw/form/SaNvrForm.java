...
public class SaNvrForm implements Serializable {
    ...
    private SaNvrListForm listForm;
    //涉案财物NVR字段
    ...
    public SaNvrListForm getListForm() {
        return listForm;
    }

    public void setListForm(SaNvrListForm listForm) {
