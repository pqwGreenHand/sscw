...
public class SecurityAppEntity implements java.io.Serializable{
	...
	public Long getSerialAreaId() {
		return serialAreaId;
	}

	public void setSerialAreaId(Long serialAreaId) {
		this.serialAreaId = serialAreaId;
	}
