 ...
 */
@Controller
@RequestMapping("/zhfz/zhag/xzajgj")
public class XzajgjController {

    private static Logger logger = Logger.getLogger(XzajgjController.class);
    ...
    @ResponseBody
    public Map<String, Object> listXzangj(@RequestParam Map<String, Object> param, HttpServletRequest request,
                                          HttpServletResponse response) {

        Map<String, Object> map = ControllerTool.mapFilter(param);
        List<GjxxEntity> list = null;
        int total = 0;
        list=this.xsajgjService.listXzangj(map);
        total=this.xsajgjService.xzanCount(map);
